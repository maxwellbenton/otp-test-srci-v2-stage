    ...
    try {
      ...
      if(cards.length) {
        ...
        try {
          ...
          console.warn(document.querySelector('src-otp-input').shadowRoot)
          console.warn(document.querySelector('src-otp-input').shadowRoot.querySelector('sal-code-input'))
          console.warn(ocument.querySelector('src-otp-input').shadowRoot.querySelector('sal-code-input').shadowRoot)
          ...
          salInputShadow.querySelector('.al-input--code__fields').setAttribute("autocomplete", "one-time-code")
